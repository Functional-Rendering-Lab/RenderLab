...
/// <param name="ApiVersion">Vulkan API version requested at instance creation (e.g. <c>Vk.Version11</c> on Android, <c>Vk.Version13</c> on desktop).</param>
/// <param name="DepthFormat">Best supported depth format: D32_SFLOAT on desktop, may fall back to D24_UNORM_S8_UINT on mobile.</param>
...
/// <param name="SupportsGeometryShader">Whether geometry shaders are available. Typically false on mobile GPUs.</param>
/// <param name="SupportsTessellation">Whether tessellation shaders are available. Typically false on mobile GPUs.</param>
